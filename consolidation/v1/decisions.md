...
Import authorization and its measured size exception remain pending. Security review,
production import, media import, installers, and all advanced scope are deferred.
